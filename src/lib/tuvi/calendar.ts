 ...
 * (c) 2006 Ho Ngoc Duc - Ported to TypeScript
 */
...
/**
 * Get sun longitude with timezone
 */
 ...
 */
export function L2S(lunarD: number, lunarM: number, lunarY: number, lunarLeap: number, tZ: number = 7): [number, number, number] {
